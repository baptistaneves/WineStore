using MediatR;
using WineStore.Core.DomainObjects.DTOs;
using WineStore.Core.Extesions;
...
namespace WineStore.Vendas.Application.Commands
{
        ...
        IRequestHandler<CancelarProcessamentoPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AdicionarEvento(new PedidoItemAdicionadoEvent(message.ClienteId, message.ProdutoId, pedido.Id, message.ValorUnitario, message.Quantidade, message.Nome));
        ...
        public async Task<bool> Handle(IniciarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            var listaProdutosPedido = new ListaProdutosPedido { Itens = itensList, PedidoId = pedido.Id };
